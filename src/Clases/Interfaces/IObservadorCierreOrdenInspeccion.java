...
public interface IObservadorCierreOrdenInspeccion {
     ...
     */
    void actualizar(String identificadorSismografo, String estado, LocalDateTime fechaHora, List<String> motivosYComentarios, String tituloPantalla, List<String> emailsResponsables);
}
